  ...
  return (
    <footer className="bg-foreground text-background w-full relative font-hind-madurai ">
      <div className=" absolute z-10 top-[-16%] md:top-[-20%]  left-[-20%]  aspect-auto w-[50%] md:w-[100%] transition animate-none md:animate-[sailTravle_30s_linear_infinite] ">
        <Image src={BoatImg} alt={"image of something"} height={150} width={150} className=" h-[100%] origin-center  transition animate-[sail_5s_linear_infinite] "></Image>
      </div>
      ...
      <div className="col-main ">
        <div className="grid gap-l grid-cols-1 sm:grid-cols-2 py-2xl lg:grid-cols-3">
          ...
          <div id="contact">
            ...
            <p>
              <strong>Festival Headquarters:</strong> <br /> Norhaven, Mythical Grounds, <br />
            ...
            <div className="flex gap-xs pt-s ">
              <Image src={Facebook} alt="facebook icon" width={30} height={30} className="cursor-pointer fill-green hover:scale-110 transition-all" />
              <Image src={X} alt="X icon" width={30} height={30} className="cursor-pointer hover:scale-110 transition-all" />
              <Image src={Instagram} alt="instagram icon" width={30} height={30} className="cursor-pointer hover:scale-110 transition-all" />
            </div>
          </div>

          {/* About us */}
          <div className="relative ">
            <Image src={Circle} alt="circle" width={300} height={300} className="absolute top-[35%] lg:top-[30%] left-1/4 transform -translate-x-1/2 -translate-y-1/2  object-cover mix-blend-difference hidden sm:block" />
            ...
            <div className="sm:pl-6 relative z-10 sm:text-foreground">
              ...
              <div className="flex flex-col ">
                <Link className=" hover:scale-110 transition-all origin-left" href={"/about#faq"}>
                  FAQ
                </Link>
                <Link className=" hover:scale-110 transition-all origin-left" href={"/about"}>
                  About us
                </Link>
                <Link className=" hover:scale-110 transition-all origin-left" href={"#contact"}>
                  Contact
                </Link>
              </div>
            </div>
          ...
          <div className="-order-1 sm:col-span-2 lg:col-span-1 lg:order-1 mb-xs">
            <h3 className="text-step-3 font-germania-one pb-s" id="form-footer-header">
              Stay updated
            </h3>
            <FooterForm />
          </div>
